...
An interactive, evidence-backed atlas mapping implementation, bootstrapping, runtime, and influence relationships across 152 nodes: 131 programming languages and 21 compiler/runtime tools. 304 indexable pages, 444 sourced relationships.
...
<p align="center">
  <img src="public/og-image.png" alt="Language Lineage: what programming languages are written in. 152 languages and tools, 444 sourced relationships." width="900">
</p>
...
│   └── v5/                            152 nodes, 444 relationships (current)
...
- 444 relationships, each with confidence score and evidence source URL
...
152 nodes and 444 relationships. Accessed 2026. https://www.languagelineage.org/dataset
```
