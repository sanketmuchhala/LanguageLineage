  ...
  return (
    <div className="landing">
      ...
      <section className="hero">
        ...
        <div className="hero-inner">
          ...
          <p className="hero-subtitle reveal">
            ...
            language family tree of 152 languages and toolchains and 444 sourced
      ...
      <section className="stats-bar">
        ...
        <div className="stat reveal">
          <span className="stat-number">444</span>
      ...
      <section className="section more-than-section">
        <div className="section-header">
          ...
          <p className="section-text centered reveal">
            ...
            bootstrap chains each language actually uses. 152 languages and toolchains, 444
