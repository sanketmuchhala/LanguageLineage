      ...
      <footer className="landing-footer">
        <div className="footer-content">
          ...
          <div className="footer-makers">
            <span className="makers-label">Made by</span>
            <div className="makers-handles">
              <a
                href="https://github.com/aniketsingh0104"
                target="_blank"
                rel="noopener noreferrer"
                className="maker-handle"
              >
                ...
                <span className="maker-name">Aniket Singh</span>
                <span className="maker-username">@aniketsingh0104</span>
              </a>
              <span className="makers-and">&</span>
              <a
              ...
              >
                ...
                <span className="maker-name">Rishabh Tripathi</span>
                <span className="maker-username">@ristri</span>
              </a>
            </div>
          </div>
        ...
        <div className="footer-bottom">
          <p>&copy; 2026 Rishabh Tripathi &amp; Aniket Singh</p>
        </div>
      </footer>
    </div>
  );
